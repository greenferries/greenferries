...
class CreateShipTypesWwwwDataFiles(object):
    def run(self):
        ...
        data = {
            ...
            "totalShipsCount": get_frontmatter_df(exclude_out_of_scope=True).shape[0]
        }
        print(data)
...
if __name__ == "__main__":
    CreateShipTypesWwwwDataFiles().run()
